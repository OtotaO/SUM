...
judge (mDeBERTa-v3-xnli). opus-100 aggregates OPUS sources and its dataset card declares no licence, so
the raw text is not redistributed here; the committed corpus pointer is
sha256-pinned instead. As with BillSum, the French side is the corpus's own
