...
opus-100 (mixed-licence, raw text not redistributed) --- over each corpus's own
...
\subsection{Translation (opus-100, mixed-licence)}\label{sec:translation}

First 64 length-aligned EN$\to$FR pairs of opus-100, local multilingual NLI
judge (mDeBERTa-v3-xnli). opus-100 aggregates mixed-licence OPUS sources, so
...
\item \textbf{Source.} \url{https://github.com/OtotaO/SUM}, Apache-2.0.
  ...
  \texttt{swh:1:snp:\allowbreak 93b83ca29d9b468a9f034f0bc3d4259983d63339},
  which captures \texttt{main} at commit \texttt{996707c} (origin
