...
deployment, never per-document truth and never ``meaning'' itself. We demonstrate on two public-domain corpora, over each corpus's own
...
Every number in \S\ref{sec:empirical} is reproducible from committed bytes.
